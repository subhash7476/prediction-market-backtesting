...
NAME = "polymarket_quote_tick_pmxt_final_period_momentum"
...
STRATEGY_CONFIGS = [
    {
        "strategy_path": "strategies:QuoteTickFinalPeriodMomentumStrategy",
...
def run() -> None:
    run_reported_backtest(
        backtest=BACKTEST,
        report=REPORT,
        empty_message="No PMXT final-period sims met the quote-tick requirements.",
    )
